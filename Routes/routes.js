...
import { adminController, AdmindeleteItem } from '../Controller/admin.controller.js'
...
routes.delete('/AdmindeleteItem/:id',AdmindeleteItem)
// routes.get('/getallfoods',getallfood)
